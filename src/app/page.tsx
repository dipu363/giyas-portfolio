...
const technologies = [
  ...
  {
    name: "Spring Boot",
    image: "/images/tech/springboot.png",
  },
    {
    name: "Angular",
    image: "/images/tech/angular.png",
  },
  ...
  {
    name: "REST API",
    image: "/images/tech/rest-api.png",
  },
  {
    name: "Firebase",
    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-white">
          <div className="mx-auto grid min-h-[calc(100vh-64px)] max-w-7xl items-center gap-16 px-6 py-20 lg:grid-cols-2 lg:px-8">
            {/* ================= LEFT CONTENT ================= */}
            ...
            <div className="relative z-10">
              ...
              {/* Small Heading */}
              <p className="animate-fade-up-delay-1 mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-emerald-600">
                Flutter & Java Developer
              </p>

              {/* Main Heading */}
              <h1 className="animate-fade-up-delay-1 max-w-3xl text-5xl font-bold leading-[1.05] tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
                Building Mobile
              ...
              {/* Introduction */}
              <p className="animate-fade-up-delay-2 mt-7 max-w-xl text-base leading-7 text-gray-600 sm:text-lg">
              ...
              {/* Stats */}
              <div className="animate-fade-up-delay-3 mt-12 flex flex-wrap gap-8 border-t border-gray-100 pt-8 sm:gap-12">
                <div>
            ...
            <div className="animate-fade-in relative flex items-center justify-center lg:justify-end">
              ...
              <div className="relative h-[440px] w-full max-w-[390px]">
                ...
                {/* Main Developer Card */}
                <div className="absolute inset-x-5 bottom-5 top-14 rounded-[2rem] bg-gray-50 shadow-sm">
                  {/* Decorative Green Circle */}
                  <div className="absolute -left-5 top-20 h-20 w-20 rounded-full bg-emerald-100" />

                  {/* Profile Image */}
                  <div className="animate-float absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-full border-[10px] border-white bg-emerald-600 shadow-2xl">
                    <Image
        ...
        <section className="border-t border-gray-100 bg-gray-50">
          <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10">
              {technologies.map((technology) => (
                <div
                  key={technology.name}
                  className="group flex min-h-[120px] flex-col items-center justify-center rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-md"
                >
                  <Image
            ...
            <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-base leading-7 text-gray-600">
                  ...
                  worked on, focusing on practical solutions, performance,
                  and user experience.
                </p>
              </div>
